...
export const myProjects = [
  ...
  },
  {
    ...
    description:
      "A health platform with secure auth, live data, and an AI-assisted chatbot.",
    subDescription: [
      "Integrated a chatbot for preliminary health guidance.",
      "Implemented secure authentication and session management.",
      "Integrated MongoDB for real-time doctor listings and content sync.",
      "Built a responsive, accessible UI with React and Tailwind CSS.",
    ],
