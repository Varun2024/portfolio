      ...
      <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[var(--color-midnight)] to-[var(--color-primary)] p-5 sm:p-7">
        <div className="flex items-center gap-3">
          <div className="relative h-3 w-3">
            <span className="absolute inset-0 rounded-full bg-[var(--color-lavender)] animate-ping opacity-75" />
            <span className="absolute inset-0 rounded-full bg-[var(--color-lavender)]" />
          </div>
        ...
        <div className="mt-4 h-[2px] w-full overflow-hidden rounded-full bg-white/10">
          <div className="h-full w-1/3 animate-pulse rounded-full bg-gradient-to-r from-[var(--color-royal)] via-[var(--color-lavender)] to-[var(--color-aqua)]" />
        </div>
